...
class ControllerCatalogProduct extends Controller
{
    ...
    protected function getList()
    {
        ...
        $data['addProductCategory'] = $this->url->link('catalog/product/add-product-category&user_token=' . $this->session->data['user_token']);
    ...
    protected function getForm()
    {
        ...
        $data['pricings'] = $this->model_catalog_pricing->getList();

        if (isset($this->request->post['tax_class_id'])) {
            $data['pricing_id'] = $this->request->post['pricing_id'];
        } else {
            $data['pricing_id'] = $product_info['pricing_id'];
        }

        $this->load->model('catalog/pricing');

        $data['pricing'] = $this->model_catalog_pricing->getList();
