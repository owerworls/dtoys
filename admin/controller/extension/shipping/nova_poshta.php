...
class ControllerExtensionShippingNovaPoshta extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['shipping_nova_poshta_total'])) {
			$data['shipping_nova_poshta_total'] = $this->request->post['shipping_nova_poshta_total'];
		} else {
			$data['shipping_nova_poshta_total'] = $this->config->get('shipping_nova_poshta_total');
		}
