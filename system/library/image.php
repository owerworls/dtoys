...
class Image
{
     ...
     * @param    int $quality
     */
    public function save($file, $quality = 40)
    {
        $info = pathinfo($file);
        ...
        if (is_resource($this->image)) {
            ...
            if (in_array('imagick', get_loaded_extensions()) || ($extension == 'jpeg' || $extension == 'jpg')) {
                try {
                    ...
                    file_put_contents($_SERVER['DOCUMENT_ROOT'] . '/image_library.log', 'Exception caught: ', $e->getMessage(), "\n");
                }
            }
        }
    }
